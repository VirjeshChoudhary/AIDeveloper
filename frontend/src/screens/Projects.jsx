...
const Projects = () => {
  ...
  function addCollaborators() {
    axios
      ...
      .then((res) => {
        // console.log(res.data,"add users");
  ...
  function WriteAiMessage(message) {
    ...
    try {
      ...
      // message is plain text, do nothing
    }
  ...
  useEffect(() => {
    ...
    // Fetch project and users as before
    axios
        ...
        <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
          ...
          <div className="inputField w-full flex absolute bottom-0">
            <input
              ...
              className="p-2 px-4 border-none bg-white outline-none flex-grow"
              type="text"
